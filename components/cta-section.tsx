    ...
    <SectionWrapper className="py-24 lg:py-32 bg-[#1E5AA8] relative overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-8 relative z-10">
        <div className="text-center">
          ...
          >
            Projeniz İçin En Doğru Çözümü Birlikte Bulalım
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            45 yılı aşkın tecrübemiz ve geniş makine filomuzla ihtiyaçlarınıza özel, hızlı ve güvenilir çözümler sunuyoruz.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <Button
              asChild
              size="lg"
              className="bg-white text-[#1E5AA8] hover:bg-white/90 px-8 py-6 text-base font-medium group shadow-xl"
            >
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="border-white/40 text-white hover:bg-white/10 hover:border-white px-8 py-6 text-base font-medium bg-transparent group"
            >
              <a href="tel:+902163141294" className="flex items-center gap-2">
